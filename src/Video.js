        ...
        return (
            <div>
                {this.state.askForUsername === true ?
                    <div>
                        <div style={{
                            width: "30%", height: "auto", padding: "0px", minWidth: "400px",
                            textAlign: "center", margin: "auto", marginTop: "50px", justifyContent: "center"
                        }}>
                            <h3 style={{ color: "white", paddingRight: "10px" }}>Set an username</h3>
                            <Input style={{ color: "white" }} placeholder="Username" value={this.state.username} onChange={e => this.handleUsername(e)} />
                        ...
                        <div style={{ justifyContent: "center", textAlign: "center", paddingTop: "20px" }}>
                            <video id="my-video" ref={this.localVideoref} autoPlay muted style={{
                                borderStyle: "solid", borderColor: "purple", objectFit: "fill", width: "45%", height: "30%"
                            }}></video>
                        </div>
                    </div>
                    :
                    <div>
                        ...
                        <div className="container">
                            ...
                            <Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
                                <video id="my-video" ref={this.localVideoref} autoPlay muted style={{
                                    borderStyle: "solid", borderColor: "pink", margin: "10px", objectFit: "fill",
